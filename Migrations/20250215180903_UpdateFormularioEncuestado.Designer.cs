...
namespace SavalAPI.Migrations
{
    ...
    [Migration("20250215180903_UpdateFormularioEncuestado")]
    partial class UpdateFormularioEncuestado
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Encuestado", b =>
                {
            ...
            modelBuilder.Entity("FormularioEncuestado", b =>
                {
                    ...
                    b.Property<string>("IdEncuestado")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasKey("IdFormulario", "IdEncuestado", "Fecha");
            ...
            modelBuilder.Entity("FormularioEncuestado", b =>
                {
                    b.HasOne("Encuestado", "Encuestado")
                        .WithMany("FormulariosEncuestados")
            ...
            modelBuilder.Entity("Encuestado", b =>
                {
                    b.Navigation("FormulariosEncuestados");
                });
